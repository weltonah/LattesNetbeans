...
<div class="mx-auto" style="margin: 0 auto; width: 80%; position: relative;">
    <div class="col-sm-12">
    <h3>Como a ferramenta analisa os Depósitos de patentes internacionais: </h3>
    ...
    <h5>3) Busca em todos os itens que não possuem como país o Brasil, analisa em relação ao triênio para ser contabilizado.
    </h5>
    </div>
</div>
