...
<div class="mx-auto" style="margin: 0 auto; width: 80%; position: relative;">
    <div class="col-sm-12">
    <h3>Como a ferramenta analisa a Co-orientação de Doutorado Concluída: </h3>
    ...
    <h5>4) Somados os itens de co-orientação concluidos a ferramenta seleciona os itens em que
        o docente é co-orientador e
