...
<div class="mx-auto" style="margin: 0 auto; width: 80%; position: relative;">
    <div class="col-sm-12">
    <h3>Como a ferramenta analisa a Orientação de Doutorado em Andamento: </h3>
    ...
    <h5>4) Somados os itens de orientação em andamento a ferramenta seleciona os itens em que
