...
<div class="mx-auto" style="margin: 0 auto; width: 80%; position: relative;">
    <div class="col-sm-12">
    <h3>Como a ferramenta analisa a formação de Doutor: </h3>
    <h5>1) Vai no Capitulo Formação acadêmica/titulação  (como na figura abaixo)</h5>
    <img src="<c:url value="/resources/images/Doutorparte1.png"/>" class="img-responsive" style="border:solid;" />
    <h5>2) Analisa se o docente possui uma formação de doutorado ou não.
    </h5>
    </div>
</div>
