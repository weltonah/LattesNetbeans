...
<div class="mx-auto" style="margin: 0 auto; width: 80%; position: relative;">
    <div class="col-sm-12">
    <h3>Como a ferramenta analisa a Orientação de Doutorado Concluída : </h3>
    ...
    <h5>4) Somados os itens de orientação em andamento e concluidos a ferramenta seleciona os itens em que
