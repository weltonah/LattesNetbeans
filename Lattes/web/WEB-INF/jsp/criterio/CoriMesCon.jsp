...
<div class="mx-auto" style="margin: 0 auto; width: 80%; position: relative;">
    <div class="col-sm-12">
    <h3>Como a ferramenta analisa a Co-Orientação de Mestrado Concluída: </h3>
    ...
    <h5>4) Somados os itens de co-orientação em andamento e concluidos a ferramenta seleciona os itens em que
