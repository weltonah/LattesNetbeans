...
<div class="mx-auto" style="margin: 0 auto; width: 80%; position: relative;">
    <div class="col-sm-12">
    <h3>Como a ferramenta analisa os Trabalhos Completos em Eventos Internacionais: </h3>
    <h5>1) Vai no Capítulo de Produção do Lattes e na seção Produção bibliográfica (como na figura abaixo)</h5>
    ...
    <h5>3) Busca em todos os itens todos os eventos que tem carater internacionais, 
        analisa em relação ao triênio para ser contabilizado.
    </h5>
    <h5>Atenção: A ferramenta não contabiliza RESUMOS publicados em congresso como trabalhos completos </h5>
    </div>
</div>
