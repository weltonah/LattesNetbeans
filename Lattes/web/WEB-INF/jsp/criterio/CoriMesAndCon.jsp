...
<div class="mx-auto" style="margin: 0 auto; width: 80%; position: relative;">
    <div class="col-sm-12">
    <h3>Como a ferramenta analisa a Co-orientação de Mestrado em andamento/concluída: </h3>
    ...
    <h5>6) Vai no item Dissertação de mestrado (como na figura abaixo) </h5>
    <img src="<c:url value="/resources/images/Mesparte3.png"/>" class="img-responsive"  style="border:solid;"/>
    <h5>7) Somados os itens de co-orientação em andamento e concluidos a ferramenta seleciona os itens em que
        o docente é co-orientador, analisa em relação ao triênio para ser contabilizado.
    </h5>
