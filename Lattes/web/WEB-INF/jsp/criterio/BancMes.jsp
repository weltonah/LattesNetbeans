...
<div class="mx-auto" style="margin: 0 auto; width: 80%; position: relative;">
    <div class="col-sm-12">
    <h3>Como a ferramenta analisa Banca de Mestrado externa ao programa: </h3>
    ...
    <h5>2) Vai no item Mestrado (como na figura abaixo) </h5>
    <img src="<c:url value="/resources/images/Mesparte2.png"/>" class="img-responsive"  style="border:solid;"/>
