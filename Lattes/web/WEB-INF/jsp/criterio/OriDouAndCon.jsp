...
<div class="mx-auto" style="margin: 0 auto; width: 80%; position: relative;">
    <div class="col-sm-12">
    <h3>Como a ferramenta analisa a Orientação de Doutorado em andamento/concluída: </h3>
    ...
    <img src="<c:url value="/resources/images/Douparte3.png"/>" class="img-responsive"  style="border:solid;"/>
    <h5>7) Somados os itens de orientação em andamento e concluidos a ferramenta seleciona os itens em que
        o docente é orientador principal,
