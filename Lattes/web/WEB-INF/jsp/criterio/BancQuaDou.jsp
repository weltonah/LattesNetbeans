...
<div class="mx-auto" style="margin: 0 auto; width: 80%; position: relative;">
    <div class="col-sm-12">
    <h3>Como a ferramenta analisa Banca de Qualificação de Doutorado externa ao programa: </h3>
    ...
    <h5>2) Vai no item Qualificações de Doutorado (como na figura abaixo) </h5>
    <img src="<c:url value="/resources/images/DouQualiparte2.png"/>" class="img-responsive"  style="border:solid;"/>
